...
| **Projeto**                                                 | **Ambiente de Construção**               | **Linguagem**        |  **Data Entrega** |
| ----------------------------                                        | ----------------------        | -------------        | -------------     |
|Responder Perguntas a partir de base de dados                       | Google Colab                  | Python    | 21/05/2023        |
...
# 1.1.	Quantos filmes estão disponíveis no dataset?
| **Função** | **Documentação** | **Explicação**|
| -----               | -----                 | ------ |
